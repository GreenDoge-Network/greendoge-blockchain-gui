...
import { CopyToClipboard, Flex, Link, Loading } from '@greendoge/core';
import {
  Button,
  Dialog,
  DialogActions,
          ...
          {loading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/GreenDoge-Network/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
