...
import { AlertDialog, Card, Flex } from '@greendoge/core';
import isElectron from 'is-electron';
import { newBuy, newSell, addTrade, resetTrades } from '../../modules/trade';
import { greendoge_to_dog, colouredcoin_to_dog } from '../../util/greendoge';
...
export default function CreateOffer() {
  ...
  function handleAdd() {
    ...
    const trade =
      buy_or_sell.value === 1
        ? newBuy(dog, wallet_id.value)
        : newSell(dog, wallet_id.value);
