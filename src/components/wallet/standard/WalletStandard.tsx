...
import { /* dog_to_greendoge_string, */ greendoge_to_dog } from '../../../util/greendoge';
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of greendoge in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of GreenDoge that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and GreenDoge that you have just spent but is not
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send greendoge to coloured address. Please enter a greendoge
              address.
            </Trans>
          </AlertDialog>,
        ),
