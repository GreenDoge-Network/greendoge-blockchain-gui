...
import { Button, CardStep, Select, Flex, Loading } from '@greendoge/core';
import {
  Box,
  Grid,
  FormControl,
  ...
  if (showCreatePlotNFT) {
    return (
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent GDOG farming rewards. The average
    ...
    >
      ...
      {!loading && !hasNFTs && (
        <>
          <Typography variant="subtitle1">
            <Trans>
              Join a pool and get more consistent GDOG farming rewards. Create a
