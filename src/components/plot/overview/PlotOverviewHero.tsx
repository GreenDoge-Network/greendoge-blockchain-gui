...
import { CardHero, Flex, Link } from '@greendoge/core';
import { PlotHero as PlotHeroIcon } from '@greendoge/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn GreenDoge. '
              }
              <Link
                target="_blank"
