  ...
  const getMenuTemplate = () => {
    const template = [
      ...
      },
      {
        ...
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'GreenDoge Blockchain Website' }),
            click: () => {
              openExternal(
                'https://greendoge.dog',
              );
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/GreenDoge-Network/greendoge-blockchain/releases',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/GreenDoge-Network/greendoge-blockchain/blob/master/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/GreenDoge-Network/greendoge-blockchain/issues',
              );
            },
          },
          {
    ...
    if (process.platform === 'darwin') {
      // GreenDoge Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'GreenDoge' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About GreenDoge Blockchain' }),
            click: () => {
              openAbout();
            },
          },
